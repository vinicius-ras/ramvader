...
namespace RAMvader
{
    ...
    public class InjectedCodeCaveMemoryAddress<TMemoryAlterationSetID, TCodeCave, TVariable> : MemoryAddress
	{
		...
		public InjectedCodeCaveMemoryAddress( Injector<TMemoryAlterationSetID, TCodeCave, TVariable> injector,
		...
		{
			IntPtr injectedCodeCaveAddress = m_injector.GetInjectedCodeCaveAddress( m_codeCaveId ).Address;
			return injectedCodeCaveAddress;
		}
		#endregion
	}
}
