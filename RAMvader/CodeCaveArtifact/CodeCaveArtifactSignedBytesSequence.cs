...
namespace RAMvader.CodeInjection
{
	...
	///    to a code cave.
	/// </summary>
	public class CodeCaveArtifactSignedBytesSequence<TMemoryAlterationSetID, TCodeCave, TVariable> : CodeCaveArtifact<TMemoryAlterationSetID, TCodeCave, TVariable>
	{
		...
		public CodeCaveArtifactSignedBytesSequence( params sbyte[] bytes )
		{
