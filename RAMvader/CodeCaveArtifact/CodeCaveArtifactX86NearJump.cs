...
namespace RAMvader.CodeInjection
{
	...
	/// </summary>
	public class CodeCaveArtifactX86NearJump<TMemoryAlterationSetID, TCodeCave, TVariable> : CodeCaveArtifact<TMemoryAlterationSetID, TCodeCave, TVariable>
	{
		...
		public CodeCaveArtifactX86NearJump( EJumpInstructionType jumpInstructionType, MemoryAddress targetJumpAddress )
		{
		...
		public override byte[] GenerateArtifactBytes()
		{
			...
			byte [] result = Injector<TMemoryAlterationSetID, TCodeCave, TVariable>.GetX86NearJumpOpcode(
		...
		{
			return LowLevel.INSTRUCTION_SIZE_x86_NEAR_JUMP;
		}
		#endregion
	}
}
